...
boot().catch(error=>{
  console.error("V43B.2 bootstrap failed",error);
...
async function boot(){
  ...
  globalThis.__MEMENTO_V43B2__=globalThis.__MEMENTO_V43B__=globalThis.__MEMENTO_V43A1__=globalThis.__MEMENTO_V43A__={workspace,store,commands:bus,history,persistence,player,shell,version:"43B.2",schema:state.schema};
