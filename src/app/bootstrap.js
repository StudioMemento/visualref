...
boot().catch(error=>{
  console.error("V43C-R1 bootstrap failed",error);
...
async function boot(){
  ...
  globalThis.__MEMENTO_V43C__=globalThis.__MEMENTO_V43B__={workspace,store,commands:bus,history,persistence,player,shell,version:"43C-R1",schema:state.schema};
