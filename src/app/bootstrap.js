...
boot().catch(error=>{
  console.error("V44 bootstrap failed",error);
...
async function boot(){
  ...
  globalThis.__MEMENTO_V44__=globalThis.__MEMENTO_V43C__=globalThis.__MEMENTO_V43B__={workspace,store,commands:bus,history,persistence,player,shell,version:"44",schema:state.schema};
