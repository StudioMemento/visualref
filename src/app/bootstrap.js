...
boot().catch(error=>{
  console.error("V43B.4 bootstrap failed",error);
...
async function boot(){
  ...
  globalThis.__MEMENTO_V43B4__=globalThis.__MEMENTO_V43B__=globalThis.__MEMENTO_V43A1__=globalThis.__MEMENTO_V43A__={workspace,store,commands:bus,history,persistence,player,shell,version:"43B.4",schema:state.schema};
