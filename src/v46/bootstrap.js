/* ============================================================================
   MEMENTO VISUALREF V46A · SINGLE RUNTIME WORKFLOW
...
import {createDefaultState,normalizeState} from "https://cdn.jsdelivr.net/gh/StudioMemento/visualref@48ff1e50424da0a0546ade9039f00368073f56f2/src/core/default-state.js";
import {HistoryService} from "https://cdn.jsdelivr.net/gh/StudioMemento/visualref@48ff1e50424da0a0546ade9039f00368073f56f2/src/core/history-service.js";
import {PersistenceService} from "https://cdn.jsdelivr.net/gh/StudioMemento/visualref@48ff1e50424da0a0546ade9039f00368073f56f2/src/core/persistence-service.js";
import {WorkspaceSync} from "https://cdn.jsdelivr.net/gh/StudioMemento/visualref@48ff1e50424da0a0546ade9039f00368073f56f2/src/core/workspace-sync.js";
import {ProjectStore} from "https://cdn.jsdelivr.net/gh/StudioMemento/visualref@48ff1e50424da0a0546ade9039f00368073f56f2/src/core/project-store.js";
import {CommandBus} from "https://cdn.jsdelivr.net/gh/StudioMemento/visualref@48ff1e50424da0a0546ade9039f00368073f56f2/src/core/command-bus.js";
import {registerCommands} from "https://cdn.jsdelivr.net/gh/StudioMemento/visualref@48ff1e50424da0a0546ade9039f00368073f56f2/src/core/commands.js";
import {AppShell} from "https://cdn.jsdelivr.net/gh/StudioMemento/visualref@48ff1e50424da0a0546ade9039f00368073f56f2/src/ui/app-shell.js";
import {PlayerController} from "https://cdn.jsdelivr.net/gh/StudioMemento/visualref@48ff1e50424da0a0546ade9039f00368073f56f2/src/player/player-controller.js";
import {RenderWorkspace} from "https://cdn.jsdelivr.net/gh/StudioMemento/visualref@48ff1e50424da0a0546ade9039f00368073f56f2/src/workspaces/render-workspace.js";
import {ViewportWorkspace} from "https://cdn.jsdelivr.net/gh/StudioMemento/visualref@48ff1e50424da0a0546ade9039f00368073f56f2/src/workspaces/viewport-workspace.js";
import {TimelineWorkspace} from "https://cdn.jsdelivr.net/gh/StudioMemento/visualref@48ff1e50424da0a0546ade9039f00368073f56f2/src/workspaces/timeline-workspace.js";
import {createRuntimeInstrumentation} from "https://cdn.jsdelivr.net/gh/StudioMemento/visualref@48ff1e50424da0a0546ade9039f00368073f56f2/src/v45/runtime-instrumentation.js";
